...
var $author$project$Main$initModel = {H: $elm$core$Maybe$Nothing, v: false, A: false, B: false, I: $elm$core$Maybe$Nothing};
...
var $author$project$Main$radioSelection = function (model) {
	return A2(
		$elm$html$Html$form,
		_List_Nil,
		_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$name('base-and-height'),
								$elm$html$Html$Attributes$checked(model.v),
								$elm$html$Html$Events$onClick(
								$author$project$Main$BaseAndHeight(!model.v))
							]),
						_List_Nil),
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onClick(
								$author$project$Main$ThreeSides(!model.B))
							]),
						_List_Nil),
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onClick(
								$author$project$Main$SAS(!model.A)),
...
var $author$project$Main$mkTriangleBsHeight = F2(
	function (b, h) {
		var triangle = 'M 150 150 H 180 V 50 L 150 150 ';
		return A2(
			$elm$svg$Svg$g,
			_List_Nil,
			_List_fromArray(
					...
					_List_fromArray(
						[
							...
							'Height = ' + function (i) {
								...
								$elm$core$String$fromInt(
									A2($elm$core$Maybe$withDefault, 0, h))))
						]))
				]));
	});
...
var $author$project$Main$svgBox = function (list) {
	return A2(
		$elm$svg$Svg$svg,
		_List_fromArray(
			[
...
var $author$project$Main$viewDisplayBaseAndHeight = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				model.v ? $author$project$Main$viewDisplayBaseAndHeight(model) : $elm$html$Html$text('')
			]));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{aF: $author$project$Main$init, aQ: $author$project$Main$subscriptions, aT: $author$project$Main$update, aU: $author$project$Main$view});
