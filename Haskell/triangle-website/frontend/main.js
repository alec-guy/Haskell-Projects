						...
						if ((!_v0.a.$) && (!_v0.b.$)) {
							...
							return A2(
								...
								_List_fromArray(
									[
										$elm$svg$Svg$text(
										'Area = ' + $elm$core$String$fromFloat((b1 * h2) * (1 / 2)))
									]));
						} else {
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_Nil),
								$elm$html$Html$text('Enter Height')
							]))
					])),
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A2($elm$html$Html$Attributes$style, 'text-align', 'center'),
				A2($elm$html$Html$Attributes$style, 'background-color', '#eff1f5')
			]),
		_List_fromArray(
			[
				A2(
